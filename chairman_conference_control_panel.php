<?php
	...
	//require("./include/loadconfoptionsinc.php");
	...
	$csrf_password_generator = hash('sha256', "update_conference_control_panel") . $csrf_password_generator;
...
<div class="chairman_conference_control_panel">
	<div id="page_title">Conference Control Panel</div>
	<div id="spacer"></div>
	<div id="chairman_conference_control_panel_content">
	...
	</div><!--chairman_conference_control_panel_content-->
	<div id="bottomspacer"><a href="#wrapper" title="Return to top">return to top</a></div>
</div><!--chairman_conference_control_panel-->
