...
<div class="set_interest_levels">
	<div id="page_title">papers interest levels and conflicts</div>
	<div id="spacer"></div>
	<div id="set_interest_levels_content">
		<div id="instructions">
			Select each paper to set your interest levels and your conflicts for each of the papers below.
			<?php 
