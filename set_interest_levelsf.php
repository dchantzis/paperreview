...
<div class="set_interest_levelsf">
	<div id="page_title">papers interest levels and conflicts</div>
	<div id="spacer"></div>
	<div id="set_interest_levelsf_content">
		<div id="instructions">
			Set your interest levels and your conflicts for each of the papers below.
			<br>
			Default value of interest level is 1.
			<?php 
		...
		<form id="ilufrm" name="ilufrm" method="post" action="./include/functionsinc.php?type=47">
			<fieldset>
			<legend>Set interests levels and conflicts.</legend>
			<div class="messages"><?php VariousMessages($flg); ?></div>
			<?php lpapersInterests2(); ?>
            <input type="hidden" name="csrf" id="csrf" value="<?=hash('sha256', "set_intesest_levelsf") . $csrf_password_generator?>" />
			<div class="field"><div class="submit"><input type="submit" title="Submit form" value="Submit"></div></div>
			</fieldset>
		</form>
	</div><!--interest_levels_content-->
