...
<div class="display_reviews">
	...
	<div id="display_reviews_content">
		<div id="instructions">
            Read reviews of your papers.
            <br><br>
			For each paper select the 'view' button for its review.
           	<?php if($coptions1D["AVP"] == 0){echo "<br><br><span class=\"red\">" . "Authors are not allowed to view reviews of their papers." . "</span>";} ?> 
		</div>
		<?php display_reviews("author"); ?>
