...
<div class="papers_display_options">
	<div id="page_title">Papers Display Options</div>
	<div id="spacer"></div>
	<div id="papers_display_options_content">
		<div id="instructions">Select a way to view the conference papers.</div>
			<ul class="pdo_types">
				<li><a href="display_papers_ch.php" class="simple">Display all papers</a></li>
				<li><a href="display_abstracts.php" class="simple">Display all papers</a> (compact mode)</li>
