...
<div class="users_actions_log">
	<div id="page_title">Users Actions Log (Database)</div>
	<div id="spacer"></div>
		<? 
		...
		?>
			<form id="sconfform" name="sconfform" method="post" action="./include/functionsinc.php?type=9&action=users_actions_log_db">
				<? conf_combo_box(); ?>
                <input type="hidden" name="csrf" id="csrf" value="<?=hash('sha256', "users_actions_log_db") . $csrf_password_generator?>" />
	...
	<div id="users_actions_log_content">
		<div id="instructions">
            ...
            <br>
            To view the log regarding actions/errors outside of a conference, click <a href="./users_actions_log_db.php?mode=0" class="simple">here</a>
		</div>

	<?php
		display_db_users_actions_log($mode);
	?>
