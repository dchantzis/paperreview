...
<div class="assign_papers">
	<div id="page_title">Assign Papers To Reviewers</div>
	<div id="spacer"></div>
	<div id="assign_papers_content">

		<div id="instructions">
			Select a way to assign reviewers to papers.
			<br><br>
			<b>Note: </b> Before you assign reviewers to each paper, please use the "Force Interest Levels and Conflicts"
			action <a href="./force_interest_levels.php" class="simple">here</a>.	
		</div>
				
		<ul class="arp_types">
			<li><a href="view_assignments.php" class="simple">Assign reviewers to papers</a></li>
			<li><a href="assign_reviewersf.php" class="simple">Assign reviewers to papers</a> (FAST)</li>
		</ul>
