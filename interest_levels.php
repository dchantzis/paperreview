...
<div class="interest_levels">
	<div id="page_title">papers interest levels and conflicts</div>
	<div id="spacer"></div>
		<div id="interest_levels_content">
			<div id="instructions">Select a way to set interest levels and conflicts for each paper.</div>
				<ul class="sil_types">
					<li><a href="set_interest_levels.php" class="simple">Set interest levels</a> (using AJAX)</li>
					<li><a href="set_interest_levelsf.php" class="simple">Set interest levels</a> (FAST)</li>
				</ul>
